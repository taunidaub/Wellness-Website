...
?>
<form enctype="multipart/form-data" method="POST" ACTION="admin_sent.php">
...
<input type="text" name="title" size=55 maxlength=255 value="<? echo "$row[title]"; ?>">
</TD></TR>
...
<input type="checkbox" name="weblink" value="1">
